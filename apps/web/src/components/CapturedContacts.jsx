              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  {(contact.job_title || contact.title) && (
                    <div className="text-sm text-muted-foreground mt-0.5">{contact.job_title || contact.title}</div>
                  )}
                </div>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        ...
                        >
                          ...
                          <span className="truncate font-medium">{renderEmailAsLink(contact.email)}</span>
                        </div>
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Contact email</p>
